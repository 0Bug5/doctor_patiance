...
Note: If you are Admin,doctor or patient ,only have one page to login :)
...
Import the provided SQL file. The file is known as DATABASE SQL_Database_edoc.sql located inside the source code root folder.
